...
#### Videos
* [Learn how to deploy complete .NET Web Apps to Azure in less than 5 minutes!](https://www.youtube.com/watch?v=5nRZwxMQUFE&feature=emb_title)
* [Working with raw JSON ARM resources with Farmer](https://www.youtube.com/watch?v=a8pWqGqPKGg)
* [Authoring ARM templates the easy way with Farmer](https://www.youtube.com/watch?v=w-tgwwAR8_Y)
* [Making Infrastructure as Code Easier in Azure](https://www.youtube.com/watch?v=8E63s2QlbhA)
* [Introduction to Farmer and Stepping up the game with ARM templates](https://www.youtube.com/watch?v=k0puV8XJ59E)