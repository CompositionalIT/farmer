...
let tests =
    testList
        ...
        [ test "Can create a basic template" {
              let template =
                  arm { location Location.NorthEurope }
                  |> toTemplate
          ...
          test "Can add dependencies through IBuilder" {
              ...
              Expect.equal
                  b.Dependencies
                  (Set
                      [ storageAccounts.resourceId "aaa"
                        storageAccounts.resourceId "bbb" ])
  ...
  "param1": {
    "value": "value1"
          ...
          test "Key Vault reference parameter serializes correctly for nested deployment" {
              ...
              let kvRef1Json =
                  dict [ kvRef1.Key, kvRef1.ParamValue ]
                  |> Serialization.toJson
  ...
  "secretName": "vm-password"
              ...
              let parametersJson =
                  jobjTemplate.SelectToken("$.parameters")
                  |> string<JToken>
