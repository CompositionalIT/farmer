        ...
        [
            ...
            test "Private DNS Zone is created with records" {
                ...
                Expect.equal
                    (jobj
                        .SelectToken(
                            "resources[?(@.name=='farmer.com/aaaaName')].properties.aaaaRecords[0].ipv6Address"
                        )
                        .ToString())
                ...
                Expect.equal
                    (jobj
                        .SelectToken(
                            "resources[?(@.name=='farmer.com/_sip._tcp.name')].properties.srvRecords[0].target"
                        )
                        .ToString())
                    "farmer.online.com."
                ...
                Expect.equal
                    (jobj
                        .SelectToken(
                            "resources[?(@.name=='farmer.com/_sip._tcp.name')].properties.srvRecords[0].weight"
                        )
                        .ToString())
                    "1"
