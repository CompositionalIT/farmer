    ...
    testList
        ...
        [ test "Public DNS Zone is created with a CNAME record" {
              ...
              Expect.sequenceEqual
                  (dnsRecords.[2].ARecords
                   |> Seq.map (fun x -> x.Ipv4Address))
                  [ "192.168.0.1" ]
              ...
              Expect.equal
                  dnsRecords.[3].SoaRecord.Email
                  "azuredns-hostmaster.microsoft.com"
                  "DNS SOA record email wrong"
          ...
          test "DNS zone get NameServers" {
              ...
              let nsArm =
                  jobj
                      .SelectToken("outputs.nameservers.value")
                      .ToString()
          ...
          test "Private DNS Zone is created with records" {
              ...
              Expect.equal
                  (jobj
                      .SelectToken("resources[?(@.name=='farmer.com/www')].type")
                      .ToString())
              ...
              Expect.equal
                  (jobj
                      .SelectToken("resources[?(@.name=='farmer.com/aName')].type")
                      .ToString())
              ...
              Expect.equal
                  (jobj
                      .SelectToken("resources[?(@.name=='farmer.com/aaaaName')].type")
                      .ToString())
              ...
              Expect.equal
                  (jobj
                      .SelectToken("resources[?(@.name=='farmer.com/ptrName')].type")
                      .ToString())
              ...
              Expect.equal
                  (jobj
                      .SelectToken("resources[?(@.name=='farmer.com/txtName')].type")
                      .ToString())
              ...
              Expect.equal
                  (jobj
                      .SelectToken("resources[?(@.name=='farmer.com/mxName')].type")
                      .ToString())
              ...
              Expect.equal
                  (jobj
                      .SelectToken(
                          "resources[?(@.name=='farmer.com/_sip._tcp.name')].properties.srvRecords[0].priority"
                      )
                      .ToString())
                  "100"
              ...
              Expect.equal
                  (jobj
                      .SelectToken("resources[?(@.name=='farmer.com/soaName')].type")
                      .ToString())
