    ...
    testList "Service Bus Tests" [
        ...
        testList "Topic Tests" [
            ...
            test "Topic creates dependencies for managed linked resources" {
                ...
                Expect.containsAll resource.Dependencies [ ResourceId.create (namespaces, ResourceName "my-bus") ] ""
            }
