    ...
    testList
        ...
        [
            ...
            test "Multitier Policy converted to security rules" {
                ...
                let webPolicy =
                    securityRule { // Web servers - accessible from anything
                        name "web-servers"
                        description "Public web server access"
                        services [ "http", 80; "https", 443 ]
                        add_source_tag TCP "Internet"
                ...
                let appPolicy =
                    securityRule { // Only accessible by web servers
                        name "app-servers"
                ...
                let dbPolicy =
                    securityRule { // DB servers - not accessible by web, only by app servers
                        name "db-servers"
