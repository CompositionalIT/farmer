        ...
        [
            test "Creates a private link service for a load balancer" {
                ...
                Expect.equal
                    ...
                    (JValue
                        "[resourceId('Microsoft.Network/virtualNetworks/subnets', 'private-net', 'private-endpoints')]")
                ...
                Expect.equal
                    frontendIpConfigId
                    (JValue
                        "[resourceId('Microsoft.Network/loadBalancers/frontendIPConfigurations', 'lb', 'lb-frontend')]")
