        ...
        [ test "Can create a basic storage account" {
          ...
          test "Creates containers correctly" {
              let resources: BlobContainer list =
                  ...
                  [ for i in 1..3 do
                        account
                        |> getResourceAtIndex client.SerializationSettings i ]
          ...
          test "Adds lifecycle policies correctly" {
              let resource: ManagementPolicy =
                  ...
                  account
                  |> getResourceAtIndex client.SerializationSettings 1
          ...
          test "Creates Role Assignment correctly" {
              ...
              let roleAssignment =
                  builder.BuildResources Location.NorthEurope
                  |> List.last
              ...
              let storage =
                  builder.BuildResources Location.NorthEurope
                  |> List.head
                  :?> Farmer.Arm.Storage.StorageAccount
          ...
          test "Restrict by IP" {
              ...
              Expect.containsAll
                  (generated.NetworkRuleSet.IpRules
                   |> Seq.map (fun rule -> rule.IPAddressOrRange))
                  [ "8.8.8.8"; "8.8.8.0/24" ]
                  "Missing IP rules"
          }
          ...
          test "Sets CORS correctly" {
                  ...
                  storageAccount {
                      ...
                      add_cors_rules
                          [ StorageService.Blobs, CorsRule.AllowAll
                            ...
                            { CorsRule.AllowAll with AllowedOrigins = Specific [ Uri "https://compositional-it.com" ] }
              ...
              let rules =
                  (account |> findPropertiesResource "blobServices")
                      .properties
                      .cors
                      .corsRules
              ...
              let queueRule =
                  (account |> findPropertiesResource "queueServices")
                      .properties
                      .cors
                      .corsRules
                  |> Seq.exactlyOne
