...
let tests = testList "Diagnostic Settings" [
    test "Creates diagnostic settings with raw sinks" {
        ...
        let eventHub = authorizationRules.resourceId(ResourceName "eventhubns", ResourceName "RootManageSharedAccessKey")
    ...
    //         metrics_source logicAppResource
    //         add_destination (authorizationRules.resourceId(ResourceName "eventhubns", ResourceName "RootManageSharedAccessKey"))
    //         event_hub_destination_name "myeventhubname"
