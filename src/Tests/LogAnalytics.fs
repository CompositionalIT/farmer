...
let tests = testList "Log analytics" [
    ...
    Expect.throws (fun _ -> ( c.BuildResources Location.WestEurope |>ignore)) "asdasdsadasdasdas" 
    ...
    test "can't create log analytics  with Sku eqaul to Standard and retentionInDays doesn't eqaul to 365 " {
