...
type SearchConfig = {
    ...
    member this.AdminKey =
        let expr =
            $"listAdminKeys('Microsoft.Search/searchServices/{this.Name.Value}', '2015-08-19').primaryKey"
    ...
    member this.QueryKey =
        let expr =
            $"listQueryKeys('Microsoft.Search/searchServices/{this.Name.Value}', '2015-08-19').value[0].key"
