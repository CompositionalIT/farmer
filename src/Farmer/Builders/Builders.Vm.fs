...
type VmConfig =
    ...
    interface IBuilder with
        ...
        member this.BuildResources location = [
            ...
            // IP Address
            let mustBeStandardAndStatic = Option.isSome this.AvailabilityZone
            ...
            | Some resId ->
              { Name = resId.Name
                ...
                Zones = this.AvailabilityZone |> Option.toList
...
type VirtualMachineBuilder() =
    ...
    /// Sets the availability zone of the VM.
    [<CustomOperation "availability_zone">]
    member _.AvailabilityZone(state:VmConfig, zone) = { state with AvailabilityZone = Some zone }
