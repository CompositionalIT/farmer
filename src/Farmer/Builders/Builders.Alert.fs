...
type AlertBuilder() =
    ...
    member __.LinkedResources(state: AlertConfig, linked_resources) =
        { state with LinkedResources = linked_resources @ state.LinkedResources }
    ...
    member this.LinkedResource(state: AlertConfig, linked_resource) =
        { state with LinkedResources = linked_resource :: state.LinkedResources }
    ...
    member __.SingleCriteria(state: AlertConfig, criteria) =
        { state with Criteria = SingleResourceMultipleMetricCriteria criteria }
    ...
    member __.SingleCustomMetricCriteria(state: AlertConfig, criteria) =
        { state with Criteria = SingleResourceMultipleCustomMetricCriteria criteria }
    ...
    member __.MultiCriteria(state: AlertConfig, criteria) =
        { state with Criteria = MultipleResourceMultipleMetricCriteria criteria }
    ...
    member __.WebCriteria(state: AlertConfig, criteria) =
        { state with Criteria = WebtestLocationAvailabilityCriteria criteria }
    ...
    member __.Actions(state: AlertConfig, action) =
        { state with Actions = action :: state.Actions }
