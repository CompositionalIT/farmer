        ...
        | Some diag ->
            let logAnalyticsId, logAnalyticsKey =
                ...
                | LogAnalyticsWorkspace.WorkspaceResourceId resourceRef ->
                    (LogAnalytics.LogAnalytics.getCustomerId resourceRef.ResourceId)
                        .Eval(),
                    (LogAnalytics.LogAnalytics.getPrimarySharedKey resourceRef.ResourceId)
                        .Eval()
