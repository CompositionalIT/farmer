...
type ManagedCluster =
    {
        ...
        AgentPoolProfiles: {| Name: ResourceName
                              Count: int
                              MaxPods: int option
                              Mode: AgentPoolMode
                              OsDiskSize: int<Gb>
                              ...
                              SubnetName: ResourceName option |} list
        DnsPrefix: string
        EnableRBAC: bool
        Identity: ManagedIdentity
        IdentityProfile: ManagedClusterIdentityProfile option
        ApiServerAccessProfile: {| AuthorizedIPRanges: string list
                                   EnablePrivateCluster: bool option |} option
        LinuxProfile: {| AdminUserName: string
                         PublicKeys: string list |} option
        NetworkProfile: {| NetworkPlugin: ContainerService.NetworkPlugin option
        ...
        WindowsProfile: {| AdminUserName: string
    ...
    interface IParameters with
        member this.SecureParameters =
            [ yield!
              ...
              yield!
                  this.WindowsProfile
                  |> Option.mapList (fun wp -> wp.AdminPassword) ]
                       ...
                       linuxProfile =
                        ...
                        | Some linuxProfile ->
                            {| adminUsername = linuxProfile.AdminUserName
                               ssh =
                                {| publicKeys =
                                    linuxProfile.PublicKeys
                                    |> List.map (fun k -> {| keyData = k |}) |} |}
                        | None -> Unchecked.defaultof<_>
                       networkProfile =
