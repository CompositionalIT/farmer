...
let blobServices =
    ResourceType("Microsoft.Storage/storageAccounts/blobServices", "2022-05-01")

let containers =
    ResourceType("Microsoft.Storage/storageAccounts/blobServices/containers", "2022-05-01")

let fileServices =
    ResourceType("Microsoft.Storage/storageAccounts/fileServices", "2022-05-01")

let fileShares =
    ResourceType("Microsoft.Storage/storageAccounts/fileServices/shares", "2022-05-01")

let queueServices =
    ResourceType("Microsoft.Storage/storageAccounts/queueServices", "2022-05-01")

let queues =
    ResourceType("Microsoft.Storage/storageAccounts/queueServices/queues", "2022-05-01")

let tableServices =
    ResourceType("Microsoft.Storage/storageAccounts/tableServices", "2022-05-01")

let tables =
    ResourceType("Microsoft.Storage/storageAccounts/tableServices/tables", "2022-05-01")

let managementPolicies =
    ResourceType("Microsoft.Storage/storageAccounts/managementPolicies", "2022-05-01")

let roleAssignments =
    ResourceType("Microsoft.Storage/storageAccounts/providers/roleAssignments", "2022-05-01")
