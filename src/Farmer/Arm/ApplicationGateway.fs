...
type ApplicationGateway =
    {
        ...
        AutoscaleConfiguration: {| MaxCapacity: int option
        ...
        BackendAddressPools: {| Name: ResourceName
                                Addresses: BackendAddress list |} list
        BackendHttpSettingsCollection: {| Name: ResourceName
                                          AffinityCookieName: string option
                                          AuthenticationCertificates: ResourceName list
                                          ConnectionDraining: {| DrainTimeoutInSeconds: int<Seconds>
                                                                 Enabled: bool |} option
        ...
        GatewayIPConfigurations: {| Name: ResourceName
                                    Subnet: ResourceId option |} list
        HttpListeners: {| Name: ResourceName
                          ...
                          SslProfile: ResourceName option |} list
        Probes: {| Name: ResourceName
                   Host: string
                   Port: uint16 option
                   Path: string
                   Protocol: Protocol
                   ...
                   Match: {| Body: string option
                             StatusCodes: uint16 list |} option |} list
        RedirectConfigurations: {| Name: ResourceName
                                   IncludePath: bool
        ...
        RequestRoutingRules: {| Name: ResourceName
                                RuleType: RuleType
                                ...
                                Priority: int option |} list
        RewriteRuleSets: {| Name: ResourceName
                            RewriteRules: {| ActionSet: {| RequestHeaderConfigurations: {| HeaderName: string
                                                                                           HeaderValue: string |} list
                                                           ResponseHeaderConfigurations: {| HeaderName: string
                                                                                            HeaderValue: string |} list
                                                           UrlConfiguration: {| ModifiedPath: string
                                                                                ModifiedQueryString: string
                                                                                Reroute: bool |} |}
                                             Conditions: {| IgnoreCase: bool
                                                            Negate: bool
                                                            Pattern: string
                                                            Variable: string |} list
                                             Name: string
                                             RuleSequence: int |} list |} list
        SslCertificates: {| Name: ResourceName
                            Data: string option
                            KeyVaultSecretId: string
                            Password: string option |} list
        SslPolicy: {| CipherSuites: CipherSuite list
                      DisabledSslProtocols: SslProtocol list
                      MinProtocolVersion: SslProtocol
                      PolicyName: PolicyName
                      PolicyType: PolicyType |} option
        SslProfiles: {| Name: ResourceName
                        ...
                        SslPolicy: {| CipherSuites: CipherSuite list
                                      ...
                                      PolicyName: PolicyName
                                      PolicyType: PolicyType |} option
                        TrustedClientCertificates: ResourceName list |} list
        TrustedClientCertificates: {| Name: ResourceName; Data: string |} list
        TrustedRootCertificates: {| Name: ResourceName
                                    Data: string option
                                    KeyVaultSecretId: string |} list
        UrlPathMaps: {| Name: ResourceName
                        ...
                        PathRules: {| Name: ResourceName
                                      BackendAddressPool: ResourceName
                                      BackendHttpSettings: ResourceName
                                      FirewallPolicy: ResourceId
                                      Paths: string list
                                      RedirectConfiguration: ResourceName
                                      RewriteRuleSet: ResourceName |} list |} list
        WebApplicationFirewallConfiguration: {| DisabledRuleGroups: {| RuleGroupName: string
                                                                       Rules: int list |} list
                                                Enabled: bool
                                                Exclusions: {| MatchVariable: string
                                                               Selector: string
                                    ...
                                    properties =
                                        {|
                                            ...
                                            probe =
                                                ...
                                                |> Option.map (
                                                    tuple this.Name
                                                    >> ApplicationGatewayProbes.resourceId
                                                    >> ResourceId.AsIdObject
                                                )
                                                |> Option.defaultValue Unchecked.defaultof<_>
                                ...
                                {|
                                    ...
                                    properties =
                                        {|
                                            ...
                                            targetListener =
                                                applicationGatewayHttpListeners.resourceId (
                                                    this.Name,
                                                    cfg.TargetListener
                                                )
                                                |> ResourceId.AsIdObject
                                                        ...
                                                        actionSet =
                                                            {|
                                                                ...
                                                                urlConfiguration =
                                                                    {|
                                                                        modifiedPath =
                                                                            rule.ActionSet.UrlConfiguration.ModifiedPath
                                                                        modifiedQueryString =
                                                                            rule.ActionSet.UrlConfiguration.ModifiedQueryString
                                                                        reroute =
                                                                            rule.ActionSet.UrlConfiguration.Reroute
                                                                    |}
                                                            |}
                                                        conditions =
                                                            rule.Conditions
                                        ...
                                        {|
                                            ...
                                            sslPolicy =
                                                ...
                                                |> Option.map (fun sslPolicy ->
                                                    {|
                                                        cipherSuites =
                                                            sslPolicy.CipherSuites |> List.map CipherSuite.toString
                                                        disabledSslProtocols =
                                                            sslPolicy.DisabledSslProtocols
                                                            |> List.map SslProtocol.toString
                                                        minProtocolVersion = sslPolicy.MinProtocolVersion.ArmValue
                                                        policyName = sslPolicy.PolicyName.ArmValue
                                                        policyType = sslPolicy.PolicyType.ArmValue
                                                    |})
                                                        ...
                                                        properties =
                                                            {|
                                                                ...
                                                                backendHttpSettings =
                                                                    ...
                                                                    |> ResourceId.AsIdObject
                                                                firewallPolicy =
                                                                    pathRule.FirewallPolicy |> ResourceId.AsIdObject
                                                                redirectConfiguration =
                                                                    applicationGatewayRedirectConfigurations.resourceId (
                                                                        this.Name,
                        ...
                        webApplicationFirewallConfiguration =
                            ...
                            |> Option.map (fun cfg ->
                                {|
                                    ...
                                    maxRequestBodySize =
                                        cfg.MaxRequestBodySize |> Option.defaultValue Unchecked.defaultof<_>
                                    maxRequestBodySizeInKb =
                                        cfg.MaxRequestBodySizeInKb |> Option.defaultValue Unchecked.defaultof<_>
                                    requestBodyCheck =
                                        cfg.RequestBodyCheck |> Option.defaultValue Unchecked.defaultof<_>
