...
module private ResourceId =
    let asId (resourceId: ResourceId) = {| id = resourceId.Eval() |}
                    ...
                    {| sku =
                       ...
                       sslPolicy =
                        ...
                        |> Option.map (fun sslPolicy ->
                            {| cipherSuites =
                                sslPolicy.CipherSuites
                                |> List.map CipherSuite.toString
                       ...
                       webApplicationFirewallConfiguration =
                        ...
                        |> Option.map (fun cfg ->
                            {| disabledRuleGroups =
                               ...
                               firewallMode =
                                cfg.FirewallMode
                                |> Option.map FirewallMode.toString
                               maxRequestBodySize =
                                cfg.MaxRequestBodySize
                                |> Option.defaultValue Unchecked.defaultof<_>
                               maxRequestBodySizeInKb =
                                cfg.MaxRequestBodySizeInKb
                                |> Option.defaultValue Unchecked.defaultof<_>
                               requestBodyCheck =
                                cfg.RequestBodyCheck
                                |> Option.defaultValue Unchecked.defaultof<_>
