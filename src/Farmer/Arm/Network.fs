...
let privateEndpointsDnsZoneGroups =
    ResourceType("Microsoft.Network/privateEndpoints/privateDnsZoneGroups", "2021-05-01")
    ...
    member internal this.JsonModelProperties =
        {|
            ...
            privateEndpointNetworkPolicies =
                this.PrivateEndpointNetworkPolicies |> Option.mapBoxed (fun x -> x.ArmValue)
...
type PrivateEndpointDnsZoneGroup =
    ...
    interface IArmResource with
        ...
        member this.JsonModel =
            let dependencies = [ this.PrivateEndpoint.ResourceId ]
