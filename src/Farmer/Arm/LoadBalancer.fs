...
type LoadBalancer =
    { Name: ResourceName
      ...
      LoadBalancingRules: {| Name: ResourceName
                             ...
                             DisableOutboundSnat: bool option |} list // default true
      Probes: {| Name: ResourceName
                 Protocol: LoadBalancerProbeProtocol
                 Port: uint16
                 RequestPath: string
                 IntervalInSeconds: int
                 NumberOfProbes: int |} list
                ...
                properties =
                    {| frontendIpConfigurations =
                       ...
                       backendAddressPools =
                        ...
                        |> List.map (fun backend -> {| name = backend.Value |})
                       loadBalancingRules =
