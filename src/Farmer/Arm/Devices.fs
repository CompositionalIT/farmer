...
type ProvisioningServices =
    ...
    member this.IotHubConnection =
        ArmExpression.create $"concat('HostName={this.IotHubName.Value}.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=',{this.IotHubKey.Value})"
    member this.IotHubPath = $"{this.IotHubName.Value}.azure-devices.net"
    interface IArmResource with
